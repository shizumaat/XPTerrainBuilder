# NOAA NCEI Continuously Updated DEM (CUDEM), ninth arc-second Commonwealth of
# the Northern Mariana Islands (CNMI) topobathymetric tiles.
#
...
# Root STAC catalog for the NCEI ninth arc-second topobathy CNMI dataset
# (6 root items, verified live 2026-07-16).
catalog_url=https://noaa-nos-coastal-lidar-pds.s3.amazonaws.com/dem/NCEI_ninth_Topobathy_CNMI_9560/stac/catalog.json
...
# pseudo-collection's bounding box. Derived from the union of the 6 catalog
# item bboxes padded by 0.1 degree (raw union 145.00,14.00,146.00,15.50;
# verified live 2026-07-16). Covers Saipan, Tinian and Rota with their
# shelves, north of Guam.
coverage_bbox=144.9,13.9,146.1,15.6

# Vertical datum. CUDEM CNMI is referenced to a LOCAL TIDAL datum
