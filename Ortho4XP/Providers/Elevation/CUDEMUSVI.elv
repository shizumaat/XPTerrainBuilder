# NOAA NCEI Continuously Updated DEM (CUDEM), ninth arc-second US Virgin
# Islands topobathymetric tiles.
#
...
# Root STAC catalog for the NCEI ninth arc-second topobathy US Virgin Islands
# dataset (9 root items, verified live 2026-07-16).
catalog_url=https://noaa-nos-coastal-lidar-pds.s3.amazonaws.com/dem/NCEI_ninth_Topobathy_USVI_9529/stac/catalog.json
...
# pseudo-collection's bounding box. Derived from the union of the 9 catalog
# item bboxes padded by 0.1 degree (raw union -65.25,17.50,-64.25,18.75;
# verified live 2026-07-16). Covers St. Croix, St. Thomas and St. John with
# their shelves. Overlaps the Puerto Rico box near Culebra; the shared
# priority means either can serve and both carry the same datum.
coverage_bbox=-65.35,17.4,-64.15,18.85

# Vertical datum. CUDEM US Virgin Islands is referenced to a LOCAL TIDAL datum
