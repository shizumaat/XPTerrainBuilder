...
## AMENDMENT (2026-08-10, lead): GUARD 1 IS STRUCK — FALSIFIED BY
MEASUREMENT. Real tunnels legitimately top out below grade (EGLL
Tunnel/6 max solid effective corner −1.594 m; Tunnel/7 −0.465 m —
35 mm from the proposed threshold), so no lawful threshold separates
them from VHHH's sea bed (−3.129). Guard 2 alone is the law; it
refuses exactly T1 (770× footprint margin) and keeps all real
tunnels. The lane's guard-1 commit (534df61) does not merge.

## The law — two admission guards on feature-A tunnel records (guard 1 STRUCK, see amendment)
