...
def _seed_elevations(layout, nodes, bucket_to_idx,
    ...
    # THE CLAIMED TUNNEL-ROAD PIN FAMILY IS RETIRED (RULINGS
    # 2026-08-31b, redesign spec §5.1, census #37).  R14-1's claim
    # re-profiled mapped road pavement to the bore profile and pinned it
    # here as a value contract; with the claim class gone there is no
    # such contract — the bore's own geometry is the RAMP, whose field
    # the portal walk authors and whose role the solve already excludes.
