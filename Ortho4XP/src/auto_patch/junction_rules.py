...
def _enforce_runway_1to1_sharing(layout: PavementLayout) -> None:
    ...
    # (2026-07-29) The sloping-rect corner guard that used to populate
    # this set was retired with the rect roles — no shape carries them
    # under the global slice, so the guard set is empty by construction.
