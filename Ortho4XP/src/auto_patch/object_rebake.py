...
# 6 -> 7 (2026-08-09, same day — the two 5->6 bumps landed in parallel
# lanes and merged as one) for the footprint-hugging pad rings
# (object-reseat-threshold-spec section 2.5 + v2b): a pad request's
# geometry is now the union of its PER-PART contact-band-triangle hulls,
...
_GATE_ENVIRONMENT_NAMES = (
    ...
    # ...and the ramp-reach gate beside them (spec lemd-basin-trench-
