...
from ..apt_dat_reader import Airport, TaxiCenterline
...
# ──────────────────────────────────────────────────────────────────────
# apt.dat 1201/1202 taxi routes
#
# MOVED here from ``apt_dat_reader`` on 2026-09-17 (lane v1retire round 1).
# Its only caller is ``pipeline.build_airport_pavement`` — v1 — and while it
# lived in the READER (a KEEP module) it was the sole reason that reader
# imported this package, a seam the 13aw inventory did not yet see.  v2
# derives its own centre lines in ``auto_patch_v2/constraints/taxi.py``.
# ──────────────────────────────────────────────────────────────────────
