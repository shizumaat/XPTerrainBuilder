...
from .project import project_runway
...
# ── the report (``solve/design_report``: the 1,000-line file law) ───────

# Re-exported here, not defined here: every importer and twin reads
# ``DesignReport`` and ``residual`` from ``solve.design``, and they still
# do.  The definitions moved verbatim to the sibling module.
from .design_report import DesignReport, residual  # noqa: E402  (re-export)
