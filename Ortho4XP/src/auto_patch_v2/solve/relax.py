...
from .stage1 import (ORDER_LEXICOGRAPHIC, ORDER_VARIANCE, ORDER_WEIGHTED, STAGE1A_FIT_WEIGHT,
                     Stage1, runway_departure, runway_fit, runway_targets, stage1, stage1a, stage1b)
from .variance import qp_available, without as _without
...
# ── stage 1: ``solve/stage1.py`` (RULINGS 2026-09-06l; re-exported here) ──
