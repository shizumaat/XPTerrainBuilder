...
def test_a_footprint_that_does_not_contain_the_trench_is_unioned(law):
    ...
    # §47 (3): the band is the STAND-OFF itself — the `+ grid` widen the
    # 09-01e "0.85 m merged" record justified is retired (that record is
    # `snap_out`'s, and `rim_standoff` already carries `ring_floor_m`)
