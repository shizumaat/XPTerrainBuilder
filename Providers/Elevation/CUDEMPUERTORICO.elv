# NOAA NCEI Continuously Updated DEM (CUDEM), ninth arc-second Puerto Rico
...
# Root STAC catalog for the NCEI ninth arc-second topobathy Puerto Rico
# dataset (26 root items, verified live 2026-07-16).
catalog_url=https://noaa-nos-coastal-lidar-pds.s3.amazonaws.com/dem/NCEI_ninth_Topobathy_PuertoRico_9525/stac/catalog.json
...
# pseudo-collection's bounding box. Derived from the union of the 26 catalog
# item bboxes padded by 0.1 degree (raw union -68.00,17.75,-65.25,18.75;
# verified live 2026-07-16). Covers Puerto Rico with its shelf.
coverage_bbox=-68.1,17.65,-65.15,18.85

# Vertical datum. CUDEM Puerto Rico is referenced to a LOCAL TIDAL datum
